...
<head>
    ...
    <style>
        ...
        footer {position: fixed; bottom: -1.5cm; left: -1.5cm; width: 120%; height: 1.5cm; border-top: solid 1px black; background: black;}
        .numero { width: 0.2cm; text-align: center;}
        .contador { width: 0.2cm; text-align:  center;}
        body { font-family: Arial, sans-serif;}
        table { width: 100%; border-collapse: collapse; position: relative; top: 0.5cm;}
